...
- def_color=default   цвет по умолчанию, mark_color, работает, только когда текущий цвет эквивалентен дефолтному,
иначе все будет отображаться тем цветом, который установлен с "="
...
по умолчанию 50 символов, ширина второй рассчитается относительно этого значения
